...
$$f \left( x \right) = \sum _{n=0} ^{l}  \left( y _{n} \prod _{k=0 \wedge k \neq n} ^{l}  \frac { \left( x-x _{k} \right) } { \left( x _{n}-x _{k} \right) } \right)$$
...
### [이미지 넣을려고 했는데 실패함 ㅋ](https://www.desmos.com/calculator/0vkq0cyeun)
